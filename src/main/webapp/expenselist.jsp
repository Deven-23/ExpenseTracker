	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td><div class="update"><a href="updateExpense?eid=<%= expense.getEid()%>">update</a></div></td>
				<td><div class="delete"><a href="deleteExpense?eid=<%= expense.getEid()%>">Delete</a></div></td>
			</tr>
